...
/*
 * Engie Claw type scale.
 *
 * An original, editorial "tool" voice: headings are heavy with tight negative
 * tracking (confident, not the soft rounded look common to AI apps), while body
 * copy stays calm and highly readable. Applied app-wide via MaterialTheme.
 */
